 ...
 * @author TEMOC
 */
public class GestionarPermisosControl extends Action{
    ...
    public void run() throws ServletException, IOException {
        ...
        sesion = usuMod.GestionarPermisos(sesion);
    ...
    public void asignaParametros() {
        ...
        switch (Integer.parseInt(paso)){
            ...
            case 1:
                ...
                break;*/
            case 1: /*case 7: case 11: case 50: case 51: case 52: case 53: case 97:*/ case 98: case 99:
                // ir a nuevo permiso(1) || cancelar nuevo permiso (98) || salir de gestionar permisos(99)
                paginaSig = request.getParameter("paginaSig")!=null?request.getParameter("paginaSig"):"";
                sesion.setPaginaSiguiente(paginaSig);
                break;
            case 2:
                //guardar nuevo permiso(3)
                Operacion permiso = new Operacion();
                permiso.setIdoperacion(Integer.parseInt(request.getParameter("operacion")));
                datos.put("permiso", permiso);
                paginaSig = request.getParameter("paginaSig")!=null?request.getParameter("paginaSig"):"";
                sesion.setPaginaSiguiente(paginaSig);
                break;
            case 3:
                //baja de permiso (2)
                datos.put("indiceper", request.getParameter("idOp"));
                paginaSig = request.getParameter("paginaSig")!=null?request.getParameter("paginaSig"):"";
                sesion.setPaginaSiguiente(paginaSig);                
                break;
        }
    ...
    /*private void CargaUsuario() {
        ...
        if (datos.get("accion").toString().equals("editar")){
            usu = (Operacion) datos.get("permiso");
            datos.put("usuact", usu.getUsuario());
        }
        usu.getEmpleado().setNumempleado(Integer.parseInt(request.getParameter("empleado")));
        try {
            usu.setUsuario(new String(request.getParameter("permiso").getBytes("ISO-8859-1"), "UTF-8"));
