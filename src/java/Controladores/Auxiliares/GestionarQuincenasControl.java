 ...
 * @author TEMOC
 */
public class GestionarQuincenasControl extends Action {
    ...
    public void run() throws ServletException, IOException {
        ...
        QuincenaMod quinMod = new QuincenaMod();
        sesion = quinMod.GestionarQuincenas(sesion);
