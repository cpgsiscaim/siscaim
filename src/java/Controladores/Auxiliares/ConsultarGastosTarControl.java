 ...
 * @author TEMOC
 */
public class ConsultarGastosTarControl extends Action{
    ...
    public void run() throws ServletException, IOException {
        ...
        MovimientoChequeraMod mcheqmod = new MovimientoChequeraMod();
        sesion = mcheqmod.ConsultarGastos(sesion);
    ...
    public void asignaParametros() {
        ...
        switch (Integer.parseInt(paso)){
            case 0:
                ...
                break;
            case 1:
                Chequera tar = new Chequera();
                tar.setId(Integer.parseInt(request.getParameter("idTar")));
