 ...
 * @author usuario
 */
public class GestionarBancosControl extends Action{
    ...
    public void run() throws ServletException, IOException {
        ...
        BancoMod banmod = new BancoMod();
        sesion = banmod.GestionarBancos(sesion);
    ...
    public void asignaParametros() {
        ...
        switch (Integer.parseInt(paso)){
            ...
            case 1: case 5: case 98: case 99:
                //nuevo banco(1) || ir a inactivos(5) || cancelar inactivos (98) || salir de gestionar bancos(99)
                paginaSig = request.getParameter("paginaSig")!=null?request.getParameter("paginaSig"):"";
                sesion.setPaginaSiguiente(paginaSig);                
                break;
            case 2: case 4: case 6:
                //editar banco(2) || baja de banco(4) || activar banco (6)
                Banco baned = new Banco();
                baned.setId(Integer.parseInt(request.getParameter("idBan")));
                datos.put("banco", baned);
                paginaSig = request.getParameter("paginaSig")!=null?request.getParameter("paginaSig"):"";
                sesion.setPaginaSiguiente(paginaSig);                
                break;
            case 3:
                ...
                if (datos.get("accion").toString().equals("editar"))
                    ban = (Banco)datos.get("banco");
                ban.setNombre(request.getParameter("nombre"));
                datos.put("banco", ban);
                paginaSig = request.getParameter("paginaSig")!=null?request.getParameter("paginaSig"):"";
                sesion.setPaginaSiguiente(paginaSig);                
                break;
