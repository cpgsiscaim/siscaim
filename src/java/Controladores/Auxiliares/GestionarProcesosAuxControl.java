 ...
 * @author usuario
 */
public class GestionarProcesosAuxControl extends Action{
    ...
    public void run() throws ServletException, IOException {
        ...
        AuxiliarMod axMod = new AuxiliarMod();
        sesion = axMod.ProcesosAuxiliares(sesion);
