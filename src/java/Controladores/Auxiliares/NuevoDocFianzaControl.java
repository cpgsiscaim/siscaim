 ...
 * @author TEMOC
 */
public class NuevoDocFianzaControl extends Action{
    ...
    public void run() throws ServletException, IOException {
        ...
        String rutaDoc = application.getRealPath("/Imagenes/Contratos/Fianzas");
        ...
        try{
            ...
            if (paso.equals("1")){
                ...
                String docnvo = mrequest.getParameter("archivoCargoFianza");
