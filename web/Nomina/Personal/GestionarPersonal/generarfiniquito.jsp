...
<%
    ...
    int dvant = Integer.parseInt(datosS.get("diasvacanti").toString());
%>
                            ...
                            <tr>
                                ...
                                <td width="30%">
                                    <input id="diasaguianio" name="diasaguianio" class="text" value="15" style="width:150px; text-align: right"
                                          onchange="CalculaAguinaldo()" readonly/>
                                </td>
                                <td width="20%">
                                ...
                                <td width="30%">
                                    <input id="porcprimavac" name="porcprimavac" class="text" value="25" style="width:150px; text-align: right"
                                           onchange="CalculaPrima()" readonly/>
                                </td>
                            </tr>
                            <tr>
                                <td width="20%">
                                ...
                                <td width="30%">
                                    <input id="diasvacpend" name="diasvacpend" class="text" value="<%=dvant%>" style="width:150px; text-align: right"
                                           onchange="CalculaVacaciones()" readonly/>
                                </td>
                                <td width="20%">
