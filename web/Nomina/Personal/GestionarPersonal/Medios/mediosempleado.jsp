...
List<PersonaMedio> listado = (List<PersonaMedio>)datosS.get("medios");
    ...
    <body onload="CargaPagina()">
                                        ...
                                        <tr>
                                            <td colspan="4" align="center">
                                                <span class="etiquetaB">
                                                    No hay Medios registrados del Empleado
                                                </span>
                                            </td>
                                        </tr>
                                    <%
        ...
        <script language="javascript">
            ...
            function NuevoClick(){
                ...
                var pagina = document.getElementById('paginaSig');
                var paso = document.getElementById('pasoSig');
                pagina.value = '/Nomina/Personal/GestionarPersonal/Medios/nuevomedio.jsp';
                paso.value = '1';
                frm.submit();                
            }
            ...
            function BajaClick(){
                var resp = confirm('¿Está seguro en dar de baja el Medio seleccionado?','SISCAIM');
                if (resp){
                    var frm = document.getElementById('frmGestionarMp');
                    var pagina = document.getElementById('paginaSig');
                    var paso = document.getElementById('pasoSig');
