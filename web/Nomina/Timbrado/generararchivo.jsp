...
int aniosel = Integer.parseInt(datosS.get("aniosel").toString());
int rpsel = datosS.get("rpsel")!=null?Integer.parseInt(datosS.get("rpsel").toString()):0;
%>
...
<html>
    ...
    <body>
                    ...
                    <tr>
                        <td width="50%" align="left">
                            <a id="btnSalir" href="javascript: SalirClick()"
                               ...
                               background: indianred 50% bottom repeat-x;" title="Salir de Generar Archivo de Timbrado">
                                Salir
                            </a>
                        </td>
                ...
                <table width="70%" align="center">
                    <tr>
                        ...
                        <td width="70%" align="left">
                            ...
                            <%
                                ...
                                %>
                                <option value="<%=suc.getId()%>" <%if(rpsel!=0 && rpsel==suc.getId()){%> selected <%}%>>
                    ...
                    <tr>
                        ...
                        <td width="70%" align="left">
                            ...
                            %>
                                <option value="<%=aniohis.toString()%>" <%if(aniosel==aniohis.intValue()){%>selected<%}%>>
                                    <%=aniohis.toString()%>
                                </option>
                            <%}%>
                            </select>
                    ...
                    <tr>
                        ...
                        <td width="70%" align="left">
                            <select id="quinsel" name="quinsel" size="6" style="width: 200px">
                            <% for (int i=0; i < quinhis.size(); i++){
                                Quincena quinh = quinhis.get(i);
                            %>
                                <option value="<%=quinh.getId()%>">
                                    <%=quinh.getMes()%> (<%=quinh.getInicio()%> - <%=quinh.getFin()%>)
                                </option>
                            <%}%>
                            </select>
                        </td>
        ...
        <script language="javascript">
            ...
            function Valida(){
                var quins = document.getElementById("quinsel");
                var idsquin = document.getElementById("quincenas");
                idsquin.value = "";
                if (quins.selectedIndex==-1){
                    MostrarMensaje("Debe elegir la quincena de timbrado");
                    return false;
                } else {
                    //carga los ids de las quincenas seleccionadas
                    
                    for (i=0; i < quins.length; i++){
                        if (quins[i].selected){
                            if (idsquin.value == ""){
                                idsquin.value = quins[i].value;
                            }
                        }
                    }
                    return true;
            ...
            function GenerarClick(){
                if (Valida()){
                    ...
                    var pagina = document.getElementById('paginaSig');
                    var paso = document.getElementById('pasoSig');
                    pagina.value = '/Nomina/Timbrado/generararchivo.jsp';
                    paso.value = '1';
                    frm.submit();
                }
            }
