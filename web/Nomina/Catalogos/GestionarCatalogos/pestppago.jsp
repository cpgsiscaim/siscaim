<%-- 
    Document   : pestppago
    Created on : Jun 15, 2012, 10:11:05 AM
    Author     : roman
--%>
...
//Titulo tituActual = null;
String tituActual = "", cargo = "", nss = "", cbanca="", estudios="";
int cotiza = 0, sucact=0;
...
if (datosS.containsKey("editarEmpleado")){
    ...
    cargo = tempo.getPersona().getCargo();
    cotiza = tempo.getCotiza();
    nss =  tempo.getNss();
    cbanca =  tempo.getCuenta();
    estudios=  tempo.getEstudios();
    //sucActual = tempo.getPersona().getSucursal();
}
%>
...
<table width="100%" align="center" cellpadding="5px" frame="box">         
    <tr>
        <td align="center">
                <span class="etiqueta">Periodos de Pago:</span>                
        </td>
    </tr>
    <tr>
        <td width="70%">
