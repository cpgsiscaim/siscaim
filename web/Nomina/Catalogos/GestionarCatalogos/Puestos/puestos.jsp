...
<%@page import="java.util.ArrayList, java.util.List,  Modelo.Entidades.Catalogos.Puestos, Modelo.Entidades.Empleado"%>
...
List<Puestos> PuestosLst = new ArrayList<Puestos>();//(List<Cliente>)datosS.get("listado");
%>
...
<html>
    ...
    <body onload="CargaPagina()">
        ...
        <hr>
        <form id="frmPuestos" name="frmPuestos" action="<%=CONTROLLER%>/Gestionar/Catalogos" method="post">
            <!-- este input oculto es por si se quiere ir a otra jsp sin procesar nada -->
            <input id="paginaSig" name="paginaSig" type="hidden" value=""/>
            <!-- este input oculto es para enviar el paso del proceso que se ejecutara -->
            <input id="pasoSig" name="pasoSig" type="hidden" value=""/>
            <input id="idPuestos" name="idPuestos" type="hidden" value=""/>
            <table width="100%">
                <tr>
                    <td width="100%">
                        <div class="titulo" align="center">
                            <table>
                                <tr>
                                    <td width="30%" align="center" valign="top">
                                        ...
                                        <img src="/siscaim/Imagenes/Nomina/Catalogos/puestosA.png" align="center" width="300" height="250">
                                    </td>
                                    <td width="70%" valign="top">
                                            ...
                                            <tr>
                                                                ...
                                                                <table id="web-buttons-id1i6bq" width=0 cellpadding=0 cellspacing=0 border=0>
                                                                    <tr>
                                                                        <td style="padding-right:0px" title ="Editar">
                                                                            <a href="javascript: EditarPuestoClick()" title="" style="background-image:url(/siscaim/Estilos/imgsBotones/editar.png);width:150px;height:30px;display:block;"><br/></a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                    ...
                                                    <table id="web-buttons-id1i6bq" width=0 cellpadding=0 cellspacing=0 border=0>
                                                        <tr>
                                                            <td style="padding-right:0px" title ="Nuevo" >
                                                                <a href="javascript: NuevoPuestoClick()" title="" style="background-image:url(/siscaim/Estilos/imgsBotones/nuevo.png);width:150px;height:30px;display:block;"><br/></a>
                                                            </td>
                                                        </tr>                                     
                                                    </table>
                                                </td>                                                                        
                                                ...
                                                <table id="borrarEdit" width="100%" style="display: none">
                                                    ...
                                                    <table id="web-buttons-id1i6bq" width=0 cellpadding=0 cellspacing=0 border=0>
                                                        <tr>
                                                            <td style="padding-right:0px" title ="Baja">
                                                                <a href="javascript: BajaPuestoClick()" title="" style="background-image:url(/siscaim/Estilos/imgsBotones/baja.png);width:150px;height:30px;display:block;"><br/></a>
                                                            </td>
                                                        </tr>
                                                    </table>                                                    
                                                    </td>
                                        ...
                                        <table class="tablaLista" width="100%">
                                            ...
                                            <%                                                
                                                PuestosLst = (List<Puestos>) datosS.get("listapuesto");
                                            %>
                                            <tbody> 
                                                <%
                                                    int nper = PuestosLst.size();
                                                    for (int i = 0; i < nper; i++) {
                                                        Puestos p = (Puestos) PuestosLst.get(i);
                                                %>
                                                
                                                <tr onclick="Activa(<%=i%>)">
                                                    <td align="center" width="10%">
                                                        <input id="radioPuestos" name="radioPuestos" type="radio" value="<%= p.getIdPuestos() %>" />
                                                    </td>
                                                    <td width="45%" align="center">                                                        
                                                        <span class="etiqueta"><%= p.getDescripcion() %></span>
                                                    </td>
                                                    <td width="45%" align="center">
                                                        <span class="etiqueta"><%= p.getSalario() %></span>
                                                    </td>                                                                                       
                                                </tr>
                                                <%
                                                    } //Fin for
        ...
        function NuevoPuestoClick(){
            var paginaSig = document.getElementById("paginaSig");
            paginaSig.value = "/Nomina/Catalogos/GestionarCatalogos/Puestos/nuevopuesto.jsp";
            var pasoSig = document.getElementById("pasoSig");
            pasoSig.value = "7";
            var frm = document.getElementById('frmPuestos');
            frm.submit();
        }
        function EditarPuestoClick(){
            var paginaSig = document.getElementById("paginaSig");
            paginaSig.value = "/Nomina/Catalogos/GestionarCatalogos/Puestos/nuevopuesto.jsp";
            var pasoSig = document.getElementById("pasoSig");
            pasoSig.value = "10";
        ...
        function BajaPuestoClick(){
            var resp = confirm('¿Está seguro en dar de baja el Puesto seleccionado?','SISCAIM');
            if (resp){
                var frm = document.getElementById('frmPuestos');
                var pagina = document.getElementById('paginaSig');
                var paso = document.getElementById('pasoSig');
                pagina.value = "/Nomina/Catalogos/GestionarCatalogos/Puestos/puestos.jsp"
                paso.value = '11';
                frm.submit();
            }
        }
        ...
        function Activa(fila){
                            var idPuestos = document.getElementById('idPuestos');
                            var borrarEdit = document.getElementById('borrarEdit');
                            borrarEdit.style.display = '';
                    <%
                        if (PuestosLst.size() == 1) {
                    %>
                            //document.frmGestionarCli.radioCli.checked = true;
                            document.frmPuestos.radioPuestos.checked = true;
                            //idCli.value = document.frmGestionarCli.radioCli.value;
                            idPuestos.value = document.frmPuestos.radioPuestos.value;
                    <%    }else {
                    %>
                            var radio = document.frmPuestos.radioPuestos[fila];//document.frmGestionarCli.radioCli[fila];
                            radio.checked = true;
                            idPuestos.value = radio.value;
                    <% }%>
        }
