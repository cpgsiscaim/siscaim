...
<%@page import="java.util.HashMap, java.util.List, Modelo.Entidades.Catalogos.TipoCambio"%>
...
<%
    ...
    if (datosS.get("accion").toString().equals("editar")){
        titulo = "Editar Tipo de Campio";        
        tcambio = (TipoCambio) datosS.get("tipocambio"); 
    }
%>
<html>
    <head>
    ...
    <body onload="CargaPagina()">
            ...
            <tr>
                <td width="100%">
                    <div class="titulo" align="center">
                        Gestionar Tipos de Cambios - <%=titulo%>
                    </div>
                </td>
            </tr>
        </table>
        <hr>
        <form id="frmNuevoTcambio" name="frmNuevoTcambio" action="<%=CONTROLLER%>/Gestionar/TiposCambios" method="post">
                                        ...
                                        <table width="100%">
                                            <tr>
                                                <td width="100%">
                                                    ...
                                                    <input id="descTcambio" name="descTcambio" type="text" 
                                                           style="width: 300px" onkeypress="return ValidaRazonSocial(event, this.value)" value="<%=tcambio.getDescripcion()!=null?tcambio.getDescripcion():""%>"
        ...
        <script language="javascript">
            function CargaPagina(){
                ...
                %>
                var desc = document.getElementById('descTcambio');
                desc.focus();

            }

            function CancelarClick(){
                var frm = document.getElementById('frmNuevoTcambio');
                frm.paginaSig.value = '/Nomina/Catalogos/GestionarCatalogos/TiposCambios/tiposcambios.jsp';
