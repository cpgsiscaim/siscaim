...
List<Sucursal> sucursalesdisp = (List<Sucursal>)datosS.get("sucursalesdisp");
                ...
                <tr>
                    <td width="50%" align="center">
                        <a id="btnGenerar" href="javascript: GenerarClick()"
                           style="width: 150px; font-weight: bold; color: #0B610B;" title="Generar la nómina">
                            Generar
                        </a>
                        ...
                        <table id="btnGenerar" width=0 cellpadding=0 cellspacing=0 border=0>
                            <tr>
                                <td style="padding-right:0px" title ="Generar la nómina">
                    ...
                    <td width="50%" align="center">
                        <a id="btnCancelar" href="javascript: CancelarClick()"
                           ...
                           background: indianred 50% bottom repeat-x;" title="Cancelar Nueva Nómina">
                            Cancelar
                        </a>
                        ...
                        <table id="btnCancelar" width=0 cellpadding=0 cellspacing=0 border=0>
                            <tr>
                                <td style="padding-right:0px" title ="Cancelar Nueva Nómina">
