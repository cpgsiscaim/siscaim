    ...
    <body onload="CargaPagina()">
            ...
            <tr>
                <td width="100%">
                    <div class="titulo" align="center">
                        Inventario / Catálogos<br>Gestionar Series
                    </div>
                </td>
            </tr>
        </table>
        <hr>
        <form id="frmGestionarSer" name="frmGestionarSer" action="<%=CONTROLLER%>/Gestionar/Series" method="post">
                        ...
                        <table>
                            <tr>
                                ...
                                <td width="80%" valign="top">
                                    ...
                                    <%
                                    List<Serie> listado = (List<Serie>)datosS.get("listado");
                                    if (listado.size()==0){
                                    %>
                                        <tr>
        ...
        <script language="javascript">
            ...
            function Activa(fila){
                ...
                if (listado.size()==1){
                %>
                    document.frmGestionarSer.radioSer.checked = true;
                    idSer.value = document.frmGestionarSer.radioSer.value;
                <%
                } else {
                %>
                    var radio = document.frmGestionarSer.radioSer[fila];
                    radio.checked = true;
            ...
            function SalirClick(){
                var frm = document.getElementById('frmGestionarSer');
            ...
            function NuevaClick(){
                ...
                var pagina = document.getElementById('paginaSig');
                var paso = document.getElementById('pasoSig');
                pagina.value = '/Inventario/Catalogos/Series/nuevaserie.jsp';
                paso.value = '1';
                frm.submit();                
            }
            ...
            function BajaClick(){
                var resp = confirm('¿Está seguro en dar de baja la Serie seleccionada?','SISCAIM');
                if (resp){
                    var frm = document.getElementById('frmGestionarSer');
                    var pagina = document.getElementById('paginaSig');
                    var paso = document.getElementById('pasoSig');
