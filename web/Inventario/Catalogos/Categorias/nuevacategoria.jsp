...
<%@page import="java.util.HashMap, Modelo.Entidades.Categoria"%>
...
<%
    ...
    String imagen = "categoriaNueva.png";
    if (datosS.get("accion").toString().equals("editar")){
        titulo = "Editar Categoría";
        imagen = "categoriaEditar.png";
        Categoria cat = (Categoria)datosS.get("categoriaEditar");
        clave = cat.getClave();
        descrip = cat.getDescripcion();
        fechaSql = cat.getFechaAlta().toString();
            ...
            <tr>
                <td width="100%">
                    <div class="titulo" align="center">
                        ...
                        Gestionar Categorías / <%=titulo%>
                    </div>
                </td>
            </tr>
        </table>
        <hr>
        <form id="frmNuevaCat" name="frmNuevaCat" action="<%=CONTROLLER%>/Gestionar/Categorias" method="post">
                                            ...
                                            <tr>
                                                ...
                                                <td width="80%" align="left">
                                                    ...
                                                    <img src="/siscaim/Imagenes/Calendario/calendario02.png" width="25" height="25"
                                                        onclick="displayCalendar(document.frmNuevaCat.rgFecha,'dd-mm-yyyy',document.frmNuevaCat.rgFecha)"
        ...
        <script language="javascript">
            function CargaPagina(){                
                ...
                if (sesion!=null && sesion.isError()){
                    Categoria catT = (Categoria)datosS.get("categoriaNueva");
                    if (datosS.get("accion").toString().equals("editar")){
                        catT = (Categoria)datosS.get("categoriaEditar");
                    }
                    SimpleDateFormat formatoDelTexto = new SimpleDateFormat("yyyy-MM-dd");
                    String fechaSqlT = formatoDelTexto.format(catT.getFechaAlta());
                ...
                %>
                    ...
                    clave.value = '<%=catT.getClave()%>';
                    descr.value = '<%=catT.getDescripcion()%>';
            ...
            function CancelarClick(){
                var frm = document.getElementById('frmNuevaCat');
                frm.paginaSig.value = '/Inventario/Catalogos/Categorias/gestionarcategorias.jsp';
