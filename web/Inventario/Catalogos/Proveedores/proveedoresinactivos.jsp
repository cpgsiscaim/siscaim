            ...
            <tr>
                <td width="100%">
                    <div class="titulo" align="center">
                        ...
                        Gestionar Proveedores - Inactivos
                    </div>
                </td>
            </tr>
        </table>
                        ...
                        <table>
                            <tr>
                                <td width="20%" align="center" valign="top">
                                    ...
                                    <img src="/siscaim/Imagenes/Inventario/Catalogos/proveedoresA.png" align="center" width="300" height="250">
                                </td>
                                <td width="80%" valign="top">
                                    ...
                                    if (paso != 0 && sucSel.getId()!=0){
                                        listado = (List<Proveedor>)datosS.get("inactivos");
                                    if (listado.size()==0){
                                    %>
                                        <tr>
                                            <td colspan="4" align="center">
                                                <span class="etiquetaB">
                                                    No hay Proveedores Inactivos en la Sucursal seleccionada
                                                </span>
                                            </td>
                                        </tr>
                                    <%
