...
<%@page import="java.util.HashMap, java.util.List, Modelo.Entidades.TipoMov, Modelo.Entidades.Serie"%>
    ...
    <body onload="CargaPagina()">
            ...
            <tr>
                <td width="100%">
                    <div class="titulo" align="center">
                        Inventario / Catálogos<br>Gestionar Tipos de Movimientos - Inactivos
                    </div>
                </td>
            </tr>
        </table>
        <hr>
        <form id="frmGestionarMovIn" name="frmGestionarMovIn" action="<%=CONTROLLER%>/Gestionar/TiposMov" method="post">
                        ...
                        <table>
                            <tr>
                                ...
                                <td width="80%" valign="top">
                                    ...
                                    <%
                                    List<TipoMov> listado = (List<TipoMov>)datosS.get("inactivos");
                                    if (listado.size()==0){
                                    %>
                                        <tr>
                                            <td colspan="4" align="center">
                                                <span class="etiquetaB">
                                                    No hay Tipos de Movimientos Inactivos
                                                </span>
                                            </td>
                                        </tr>
                                    <%
        ...
        <script language="javascript">
            ...
            function Activa(fila){
                ...
                if (listado.size()==1){
                %>
                    document.frmGestionarMovIn.radioMov.checked = true;
                    idMov.value = document.frmGestionarMovIn.radioMov.value;
                <%
                } else {
                %>
                    var radio = document.frmGestionarMovIn.radioMov[fila];
                    radio.checked = true;
            ...
            function CancelarClick(){
                var frm = document.getElementById('frmGestionarMovIn');
