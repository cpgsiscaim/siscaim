    ...
    <body onload="CargaPagina()">
            ...
            <tr>
                <td width="100%">
                    <div class="titulo" align="center">
                        Inventario / Catálogos<br>Gestionar Unidades - Inactivas
                    </div>
                </td>
            </tr>
        </table>
        <hr>
        <form id="frmGestionarUniIn" name="frmGestionarUniIn" action="<%=CONTROLLER%>/Gestionar/Unidades" method="post">
                        ...
                        <table>
                            <tr>
                                ...
                                <td width="80%" valign="top">
                                                            ...
                                                            <table id="web-buttons-id1i6bq" width=0 cellpadding=0 cellspacing=0 border=0>
                                                                <tr>
                                                                    <td style="padding-right:0px" title ="Activar">
                                                                        <a href="javascript: ActivarUniClick()" title="" style="background-image:url(/siscaim/Estilos/imgsBotones/activar.png);width:150px;height:30px;display:block;"><br/></a>
                                                                    </td>
                                                                </tr>
                                                            </table>                                                    
                                                        </td>
                                    ...
                                    <%
                                    List<Unidad> listado = (List<Unidad>)datosS.get("inactivas");
                                    if (listado.size()==0){
                                    %>
                                        <tr>
        ...
        <script language="javascript">
            ...
            function Activa(fila){
                ...
                if (listado.size()==1){
                %>
                    document.frmGestionarUniIn.radioUni.checked = true;
                    idUni.value = document.frmGestionarUniIn.radioUni.value;
                <%
                } else {
                %>
                    var radio = document.frmGestionarUniIn.radioUni[fila];
                    radio.checked = true;
            ...
            function CancelarClick(){
                var frm = document.getElementById('frmGestionarUniIn');
