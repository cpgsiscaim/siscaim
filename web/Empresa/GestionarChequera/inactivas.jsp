        ...
        <tr>
          <td width="10%" align="left">
            <a id="btnCancelar" href="javascript: CancelarClick()"
                ...
                background: indianred 50% bottom repeat-x;" title="Salir de Tarjetas dadas de baja">
                Cancelar
            </a>
          </td>
          <td width="45%" align="right">
            <a id="btnActivar" href="javascript: ActivarClick()"
                style="width: 150px; font-weight: bold; color: #0B610B; display: none" title="Activar tarjeta seleccionada">
                Activar
            </a>
          </td>
        </tr>
