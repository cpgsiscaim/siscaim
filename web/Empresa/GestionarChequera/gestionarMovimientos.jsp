                                ...
                                <tr>
                                    ...
                                    <td width="15%" align="right">
                                        <a id="btnEditar" href="javascript: EditarClick()"
                                            style="width: 150px; font-weight: bold; color: #0B610B;" title="Editar Movimiento seleccionado">
                                            Editar
                                        </a>
                                    </td>
                                    <td width="15%" align="right">
                                        <a id="btnBorrar" href="javascript: EliminarClick()"
                                            style="width: 150px; font-weight: bold; color: #0B610B;" title="Borrar Movimiento seleccionado">
                                            Borrar
                                        </a>
                                    </td>
                                </tr>
...
<script language="javascript">
        ...
        function EliminarClick()    {
            var boton = document.getElementById('boton');
            boton.value = '1';
            Confirmar('¿Está seguro de eliminar el Movimiento seleccionado?');
        }
        ...
        function EditarClick(){
            ...
            var pagina = document.getElementById('paginaSig');
            var paso = document.getElementById('pasoSig');
            pagina.value = '/Empresa/GestionarChequera/nuevoCargo.jsp';
            paso.value = '5';
            frm.submit();               
        }
