...
<%@page import="java.util.HashMap, java.util.List, Modelo.Entidades.Catalogos.TipoMedio"%>
            ...
            <tr>
                <td width="100%">
                    <div class="titulo" align="center">
                        Configurar Empresa - Editar Medio
                    </div>
                </td>
            </tr>
        </table>
        <hr>
        <form id="frmEditarMedio" name="frmEditarMedio" action="<%=CONTROLLER%>/Configurar/Empresa" method="post">
                            ...
                            <table>
                                <tr>
                                    <td width="30%" align="center" valign="top">
                                        ...
                                        <img src="/siscaim/Imagenes/Medios/mediosA.png" align="center" width="300" height="250">
                                    </td>
                                    <td width="70%" valign="center">
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td>
                                                    <input id="medio" name="medio" type="text" value="" style="width: 300px"
                                                           onkeypress="return ValidaSegunTipo(event, this.value)" maxlength=""/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
