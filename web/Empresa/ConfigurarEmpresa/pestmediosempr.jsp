<%@page import="java.util.List, java.util.ArrayList, Modelo.Entidades.Medio, Modelo.Entidades.Catalogos.TipoMedio"%>
<%
...
<table width="100%" align="center" cellpadding="5px">
    <tr>
        <td width="60%" valign="top" align="center" valign="center">
            ...
            <select id="mediosEmpr" name="mediosEmpr" size="6" style="width: 400px">
                <%
...
<script lang="javascript1.2">   
    function NuevoMedioClick(){
        ...
        paginaSig.value = '/Empresa/ConfigurarEmpresa/nuevomedioempr.jsp';
    ...
    function ModificarMedioClick(){
        var listaMedios = document.getElementById('mediosEmpr');
    ...
    function EliminarMedioClick(){
        ...
        if (listaMedios.selectedIndex==-1){
            ...
            var paginaSig = document.getElementById('paginaSig');
            paginaSig.value = '/Empresa/ConfigurarEmpresa/borrarmedio.jsp';
            var pasoSig = document.getElementById('pasoSig');
            pasoSig.value = '14';
            var frm = document.getElementById('frmConfigurarEmpr');
            frm.submit();            
