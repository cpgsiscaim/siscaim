<%@page import="java.util.List, java.util.ArrayList, Modelo.Entidades.Sucursal, Modelo.Entidades.Persona"%>
<%
...
if (datosS.containsKey("editarSuc")){
    Sucursal edSucC = (Sucursal)datosS.get("editarSuc");
    actualesCon = edSucC.getContactos();
}
...
<table width="100%" align="center" cellpadding="5px">
    <tr>
        <td width="60%" valign="top" align="center" valign="center">
            ...
            <select id="contactosSuc" name="contactosSuc" size="6" style="width: 400px">
                <%
...
<script lang="javascript1.2">
    function NuevoContactoClick(){
        ...
        paginaSig.value = '/Empresa/GestionarSucursales/nuevocontactosuc.jsp';
    ...
    function EditarContactoClick(){
        var listaContactos = document.getElementById('contactosSuc');
