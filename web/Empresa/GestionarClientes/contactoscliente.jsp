<%-- 
    Document   : contactoscliente
    Created on : 13/09/2013, 10:55:07 AM
    Author     : germain
--%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">

<%@page import="java.util.HashMap, Modelo.Entidades.Sucursal, Modelo.Entidades.Empresa, Modelo.Entidades.Cliente, java.util.List, java.util.ArrayList, Modelo.Entidades.Contactos "%>
...
<%
    ...
    Cliente cli = (Cliente)datosS.get("clienteSel");
...
<html>
    ...
    <body onload="CargaPagina()">
            ...
            <tr>
                ...
                <td width="100%" style="padding-left: 30px;">                    
                        <div class="titulo" align="center">
                            AGENDA DE CONTACTOS POR CLIENTE
                        </div>
                    <br>
                        <div class="subtitulo" align="center">
                            <%if (cli.getTipo()==0){%>
                            <%=cli.getDatosFiscales().getRazonsocial()%><br>
                            <%}%>
                            <%if (cli.getDatosFiscales().getPersona()!=null){%>
        ...
        <hr>
        <form id="frmContacxClientes" name="frmContacxClientes" action="<%=CONTROLLER%>/Gestionar/Clientes" method="post">
                            ...
                            <tr>
                                <td colspan="4" align="center">
                                    <span class="etiquetaB">
                                        No hay contactos registrados en este cliente
                                    </span>
                                </td>
                            </tr>
                            <%
        ...
        <script language="javascript">
            function EditarClick()  {
                ...
                pagina.value = '/Empresa/GestionarClientes/editarContacto.jsp';
                paso.value = '24';
                frm.submit();
            }
            ...
            function AgregarClick(){
                ...
                var pagina = document.getElementById('paginaSig');
                var paso = document.getElementById('pasoSig');
                pagina.value = '/Empresa/GestionarClientes/nuevocontCliente.jsp';
                paso.value = '20';
                frm.submit();             
            }
