...
<%@page import="java.text.SimpleDateFormat, Modelo.Entidades.Almacen, Modelo.Entidades.Producto, Modelo.Entidades.Ubicacion, Modelo.Entidades.UnidadProducto, Modelo.Entidades.Unidad"%>
...
<%
    ...
    String titulo = "AGREGAR PRODUCTOS DE "+titulo2;
    String imagen = "productosB.png";
    String descrip = "", tipo = "0", listap = "1", cant = "", categoria = "0";
            ...
            <table width="38%" align="center">
                            ...
                            <tr>
                                <td width="40%" align="left">
                                    ...
                                    <select id="tipo" name="tipo" class="combo" onchange="CargaProductos(this.value)"
                                            style="width: 200px" title="Tipo de producto">
                                ...
                                <td width="30%" align="left">
                                    ...
                                    <input id="cantidad" name="cantidad" class="text" type="text" value="1" maxlength="10"
                            ...
                            <tr>
                                <td width="40%" align="left">
                                    ...
                                    <select id="almacen" name="almacen" class="combo" style="width: 200px" onchange="CargaUbicaciones(this.value)"
                                            title="Almacén de donde se tomará el producto">                                                        
                                    <%
                                ...
                                <td width="30%" align="left">
                                    ...
                                    <select id="ubicacion" name="ubicacion" class="combo" style="width: 200px"
                                            title="Ubicación del producto en el almacén seleccionado">
                                    <%
                                    if (almacenes.size()==1){
                ...
                <tr>
                    <td width="100%" colspan="2">
                        ...
                        <select id="prods" name="prods" size="15" style="width: 500px" multiple title="Elija al menos un producto">
                        </select>
                    </td>
                </tr>
                <tr>
