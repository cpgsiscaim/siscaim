...
<%@page import="java.util.HashMap, java.util.ArrayList, Modelo.Entidades.Cliente, Modelo.Entidades.CentroDeTrabajo, Modelo.Entidades.Sucursal, Modelo.Entidades.Empresa"%>
<%@page import="Modelo.Entidades.Contrato, Modelo.Entidades.Catalogos.Titulo, Modelo.Entidades.Catalogos.TipoMedio"%>
<%@page import="java.util.List, Modelo.Entidades.ContactoCT, Modelo.Entidades.PersonaMedio"%>
...
<%
    ...
    String titulo = "NUEVO CONTACTO DE CT";
    String nombre = "", paterno = "", materno = "", sexo = "", titcon="", cargocon = "";
    List<PersonaMedio> medios = new ArrayList<PersonaMedio>();
    if (accion.equals("editar")){
        titulo = "EDITAR CONTACTO DE CT";
        ContactoCT cc = (ContactoCT)datosS.get("contacto");
        ...
        medios = (List<PersonaMedio>)datosS.get("medioscon");
    }
...
<html>
    ...
    <body onload="CargaPagina()">
        ...
        <hr>
        <form id="frmNuevoConCli" name="frmNuevoConCli" action="<%=CONTROLLER%>/Gestionar/CentrosTrab" method="post">
