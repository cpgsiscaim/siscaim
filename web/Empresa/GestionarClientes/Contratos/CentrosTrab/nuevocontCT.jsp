<%-- 
    Document   : nuevocontCT
    Created on : Oct 26, 2013, 2:05:54 PM
    Author     : marba
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@include file="/IniciarSistema/Inicializa.jsp" %>
<%@page import="java.util.HashMap, Modelo.Entidades.CentroDeTrabajo"%>
            ...
            <tr>
                ...
                <td width="80%">
                    <div class="titulo" align="center">
                        NUEVO CONTACTO EN CENTRO DE TRABAJO <%=aa.getNombre()%>                    
                    </div>
                </td>
            </tr>
        </table>
