...
<%@page import="java.util.HashMap, java.util.ArrayList, Modelo.Entidades.Cliente, Modelo.Entidades.Sucursal, Modelo.Entidades.Empresa"%>
<%@page import="Modelo.Entidades.Catalogos.Titulo, Modelo.Entidades.Catalogos.TipoMedio"%>
<%@page import="java.util.List, Modelo.Entidades.ContactoContrato, Modelo.Entidades.PersonaMedio"%>
...
<%
    ...
    String titulo = "NUEVO CONTACTO DE CONTRATO";
    String nombre = "", paterno = "", materno = "", sexo = "", titcon="", cargocon = "";
    List<PersonaMedio> medios = new ArrayList<PersonaMedio>();
    if (accion.equals("editar")){
        titulo = "EDITAR CONTACTO DE CONTRATO";
        ContactoContrato cc = (ContactoContrato)datosS.get("contacto");
...
<html>
    ...
    <body onload="CargaPagina()">
        ...
        <hr>
        <form id="frmNuevoConCli" name="frmNuevoConCli" action="<%=CONTROLLER%>/Gestionar/Contratos" method="post">
