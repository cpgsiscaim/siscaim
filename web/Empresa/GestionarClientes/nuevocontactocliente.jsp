...
<%@page import="java.util.List, Modelo.Entidades.ContactoCliente, Modelo.Entidades.PersonaMedio"%>
...
<%
    ...
    String titulo = "NUEVO CONTACTO DE CLIENTE";
    String nombre = "", paterno = "", materno = "", sexo = "", titcon="", cargocon = "";
    List<PersonaMedio> medios = new ArrayList<PersonaMedio>();
    if (accion.equals("editar")){
        titulo = "EDITAR CONTACTO DE CLIENTE";
        ContactoCliente cc = (ContactoCliente)datosS.get("contacto");
...
<html>
    ...
    <body onload="CargaPagina()">
        ...
        <hr>
        <form id="frmNuevoConCli" name="frmNuevoConCli" action="<%=CONTROLLER%>/Gestionar/Clientes" method="post">
