...
<%@page import="java.util.HashMap, java.util.List, Modelo.Entidades.Catalogos.TipoFamiliar"%>
...
<%
    ...
    String titulo = "Nuevo Tipo de Familiar";
    String imagen = "tipofamB.png";
    if (datosS.get("accion").toString().equals("editar")){
        titulo = "Editar Tipo de Familiar";
        imagen = "tipofamC.png";
        TipoFamiliar tipo = (TipoFamiliar)datosS.get("tipofam");
        descrip = tipo.getDescripcion();
    }
%>
<html>
    <head>
    ...
    <body onload="CargaPagina()">
            ...
            <tr>
                <td width="100%">
                    <div class="titulo" align="center">
                        Catálogos Varios<br>
                        Gestionar Tipos de Familiar - <%=titulo%>
                    </div>
                </td>
            </tr>
        </table>
        <hr>
        <form id="frmNuevoTF" name="frmNuevoTF" action="<%=CONTROLLER%>/Gestionar/TipoFamiliar" method="post">
        ...
        <script language="javascript">
            ...
            function CancelarClick(){
                var frm = document.getElementById('frmNuevoTF');
                frm.paginaSig.value = '/Empresa/Catalogos/TipoFamiliar/gestionartiposfam.jsp';
            ...
            function ValidaRequeridos(){
                var descrip = document.getElementById('descripcion');
                if (descrip.value == ''){
                    Mensaje('La Descripción del Tipo de Familiar está vacía');
                    descrip.focus();
                    return false;
                }
                return true;
